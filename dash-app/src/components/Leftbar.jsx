...
// const Leftbar = () => {
//   return (
//     <div className="w-1/5 p-5 min-h-screen">
//       {/* header div */}
...
//             />
//           </svg>
//           <h1 className="font-semibold text-xl leading-none tracking-normal">
//             Project M.
//           </h1>
//         </div>
//         <div className="flex ">
...
//         </div>
//       </div>
//       <hr className="border-1 border-[#DBDBDB] mt-4" />
//       <div>
//         <div>
//           <ul className="space-y-4">
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2  h-9">
//               <svg
//                 width="24"
//                 height="24"
//                 viewBox="0 0 24 24"
...
//                 />
//               </svg>
//               <h1 className="font-inter font-medium text-[16px] leading-none tracking-normal">Home</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2 h-9">
//               <svg
//                 width="24"
...
//               <h1 className="font-inter font-medium text-[16px] leading-none tracking-normal">Messages</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2 h-9">
//               <svg
//                 width="24"
...
//               <h1 className="font-inter font-medium text-[16px] leading-none tracking-normal">Tasks</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2 h-9">
//               <svg
//                 width="24"
...
//               <h1 className="font-inter font-medium text-[16px] leading-none tracking-normal">Members</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2 h-9">
//               <svg
//                 width="24"
...
//               <h1 className="font-inter font-medium text-base leading-none tracking-normal">Settings</h1>
//             </li>
//           </ul>
//         </div>
//         <hr className="border-1 border-[#DBDBDB] mt-4 mb-4" />

//         {/* projects div */}
//         <div className="mb-6 space-y-3">
//           <div className="flex items-center justify-between">
//             {" "}
//             <h1 className="font-inter font-bold text-xs text-[#787486] leading-none tracking-normal ">
//               MY PROJECTS
//             </h1>
//             <svg
//               width="16"
...
//           </div>
//           <ul className="space-y-4">
//             <li className="flex items-center  gap-2  my-4 text-[#787486] space-x-2 bg-[#5030E514]  h-9  rounded-[6px] w-full opacity-100">
//               <div class="w-2 h-2 rounded-full bg-[#7AC555] "></div>

//               <h1 className="font-semibold text-[#0D062D] leading-none tracking-normal text-base">
//                 Mobile App
//               </h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2 h-9">
//               <div class="w-2 h-2 rounded-full bg-[#FFA500]"></div>

//               <h1 className="font-inter font-medium text-base leading-none tracking-normal">Website Redesign</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486] space-x-2  h-9">
//               <div class="w-2 h-2 rounded-full bg-[#E4CCFD]"></div>

//               <h1 className="font-inter font-medium text-base leading-none tracking-normal">Design System</h1>
//             </li>
//             <li className="flex items-center gap-2 my-4 text-[#787486]  h-9 space-x-2">
//               <div class="w-2 h-2 rounded-full bg-[#76A5EA]"></div>

//               <h1 className="font-inter font-medium text-base leading-none tracking-normal">Wireframes</h1>
//             </li>
//           </ul>
//         </div>

//          {/* Thoughts div */}
//         <div className="bg-[#F5F5F5] space-y-3.5 rounded-2xl mt-6 h-52 m-4">
...
//     <h1 className="font-medium text-sm font-inter  text-[#000000]">Thoughts Time</h1>
//     <p className="text-[#787486]  tracking-normal leading-none text-xs font-normal text-center">We don’t have any notice for <br /> you, till then you can share <br /> your thoughts with your  <br />peers.</p>
//     <h2 className="leading-none tracking-normal text-sm font-medium text-[#000000] bg-white p-2 rounded-sm">Write a message</h2>
// </div>
...
const Leftbar = () => {
  return (
    <div className="w-full md:w-64 lg:w-1/5 p-4 md:p-5 min-h-screen bg-white overflow-auto  border-r-1 border-[#DBDBDB]">
      {/* Header div */}
      <div className="flex justify-between items-center space-x-1">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-semibold text-lg md:text-xl leading-none tracking-normal">
            Project M.
          </h1>
        </div>
        <div className="flex">
      ...
      <div>
        <ul className="space-y-3">
          <li className="flex items-center gap-2 my-3 text-[#787486] h-9 space-x-1">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        {/* Thoughts div */}
        <div className="bg-[#F5F5F5] space-y-3.5 rounded-2xl mt-6 p-4 h-auto min-h-[200px]">
          <div className="relative flex items-center justify-center">
            <div className="absolute w-12 h-12 rounded-full bg-yellow-300 blur-xl animate-pulse"></div>
            <svg
              width="24"
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            <h1 className="font-medium text-sm font-inter text-[#000000]">
              Thoughts Time
            </h1>
            <p className="text-[#787486] tracking-normal leading-tight text-xs font-normal text-center">
              We don’t have any notice for <br /> you, till then you can share{" "}
              <br /> your thoughts with your <br /> peers.
            </p>
            <h2 className="leading-none tracking-normal text-sm font-medium text-[#000000] bg-white p-2 rounded-sm">
              Write a message
            </h2>
          </div>
        </div>
